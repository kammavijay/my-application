...
<html>
  <head>
    ...
    <title>My JSP 'Typesoffood.jsp' starting page</title>
...
function validate()
{
   ...
   if(temp.food1.value=="" || temp.food2.value=="" || temp.food3.value=="")
   {
...
<tr>
  ...
  <%} %>
  <form action="FoodDetails.jsp" method="post" name="register" onsubmit="return validate()">
  <table width="200" border="1">
      <tr>
        <td><em><strong>Region</strong></em></td>
        <td><label>
          <select name="region"><option value="EuropeanRegion">EastRegion</option>
          <option value="MiddeleEasternRegion">MiddeleEasternRegion</option>
          <option value="SouthAsianRegion">SouthAsianRegion</option>
          <option value="FarEasternRegion">FarEasternRegion</option>
          </select>
        </label></td>
      </tr>
      <tr>
        <td><em><strong>TypesOfFood1</strong></em></td>
        <td><label>
          <input name="food1" type="text" id="food1">
        </label></td>
      </tr>
      <tr>
        <td><strong><em>TypesOfFood2</em></strong></td>
        <td><label>
          <input name="food2" type="text" id="food2">
        </label></td>
      </tr>
      <tr>
        <td height="57"><em><strong>TypesOfFood3</strong></em></td>
        <td><label>
          <input name="food3" type="text" id="food3">
        </label></td>
      </tr>
      <tr>
        <td><label></label></td>
  ...
  </table><br/><br/>    <input name="AddFoods" type="submit" id="AddFoods" value="AddFoods">
    <input name="UpdateFoods" type="submit" id="UpdateFoods" value="UpdateFoods">
   <input name="DeleteFoods" type="submit" id="DeleteFoods" value="DeleteFoods">
  </form>
    </td>
</tr>
<tr>
...
<td background="Home_files/bg.gif" width="33%"><img src="Home_files/px1.gif" height="1" width="1"></td></tr></tbody></table></body></html><br>
