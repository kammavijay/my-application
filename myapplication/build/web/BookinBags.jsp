...
<td height="19" valign="top" width="470">&nbsp;</td>
<td width="264" height="16" rowspan="2" valign="top">
<p align="right"><b>For Online booking
<a title="" href="">
<font color="#f16f01" size="2">click here</font></a></b></p></td></tr>
<tr>

  <td rowspan="2" height="262" valign="top" width="470">
  <br/>
  <br/><%if(request.getParameter("status")!=null)
  { %>
...
double noofbags=Double.parseDouble(request.getParameter("noofbags"));
BagageManagement abagage=new BagageManagement();
double cost=0;
if(noofbags<=2)
{
cost=abagage.get2bagsCost(airlines);
}
else if(noofbags==3)
{
 cost=abagage.get3bagsCost(airlines);
}
else if(noofbags>=4&&noofbags<=10)
{
cost=abagage.get4bagsCost(airlines);
}
else if(noofbags>10)
{
cost=abagage.getabove10bagsCost(airlines);
}
BagageProfile aprofile=new BagageProfile(); 
aprofile.setBid(bid);
aprofile.setAirlinesname(airlines);
aprofile.setLoginname(loginname);
aprofile.setBagname(bagname);
aprofile.setNoofbags(noofbags);
aprofile.setTotalcost(cost);
BagageManagement abagagement=new BagageManagement();
boolean flag=abagagement.loadingBagage(aprofile);
if(flag)
{%>
<table border="1" bordercolor="#663300"><tr bgcolor="#006699">
<td width="88"><div align="center"><span class="style4">Flight Booking ID</span></div></td>
<td width="88"><div align="center"><span class="style4">AirLinesName</span></div></td>
<td width="84"><div align="center"><span class="style4">Baggagename</span></div></td>
<td width="66"><div align="center"><span class="style4">Loginname</span></div></td>
<td width="98"><div align="center"><span class="style4">Noofbags</span></div></td>
<td width="107"><div align="center"><span class="style4">TotalCost</span></div></td>
</tr>
<tr><td><div align="center" class="style5"><%=bid%></div></td><td><div align="center" class="style5"><%=airlines%></div></td><td><div align="center" class="style5"><%=bagname%></div></td><td><div align="center" class="style5"><%=loginname%></div></td><td><div align="center" class="style5"><%=noofbags%></div></td><td><div align="center" class="style5"><%=cost%></div></td></tr></table>
<%}%>
