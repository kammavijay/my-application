...
%>
<tr bgcolor="#FFFFFF"><td><div align="center" class="style5"><strong><%=airlinesname%></strong></div></td><td><div align="center" class="style5"><strong><%=planename%></strong></div></td><td><div align="center" class="style5"><strong><%=fromplace%></strong></div></td><td><div align="center" class="style5"><strong><%=toplace%></strong></div></td><td><div align="center" class="style5"><strong><%=depart%></strong></div></td><td><div align="center" class="style5"><strong><%=miles%></strong></div></td><td><div align="center" class="style5"><strong><%=departtime%></strong></div></td><td><div align="center" class="style5"><strong><%=returntime%></strong></div></td><td><div align="center" class="style5"><strong><%=price%></strong></div></td></tr>
<%}%>
</table>
<% }%>
...
%>
<tr bgcolor="#FFFFFF"><td><div align="center" class="style5"><%=airlinesname%></div></td><td><div align="center" class="style5"><%=planename%></div></td><td><div align="center" class="style5"><%=fromplace%></div></td><td><div align="center" class="style5"><%=toplace%></div></td><td><div align="center" class="style5"><%=miles%></div></td><td><div align="center" class="style5"><%=depart%></div></td><td><div align="center" class="style5"><%=returndate%></div></td><td><div align="center" class="style5"><%=departtime%></div></td><td><div align="center" class="style5"><%=returntime%></div></td><td><div align="center" class="style5"><%=price%></div></td></tr>
<%}%>
</table>
<%
}
