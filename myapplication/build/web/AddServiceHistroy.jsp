...
function validate()
{
   ...
   if(temp.planename.value=="" || temp.ineragateddate.value=="" || temp.ineragatedby.value=="" || temp.usingtechnolgy.value=="" || temp.capacity.value=="")
   {
...
<tr>
  ...
  %>
  <form name="register" method="post" action="ProcessAddService.jsp" onsubmit="return validate()">
<table border="">
  <tr>
    <td>AirLinesName</td>
    <td>
      <label>
        <select name="airlines">
         <option value="IndianAirLines">IndianAirLines</option>
          <option value="KingFisher">KingFisher</option>
          <option value="DeccanAirLines">DeccanAirLines</option>
          <option value="BritishAirWays">BritishAirWays</option>
         <option value="AmericanAirLines">AmericanAirLines</option>
	</select>	 </label>
    </td>
  </tr>
  <tr>
  ...
  <tr>
    <td>InegratedDate</td>
    <td>  <input type="text" name="ineragateddate"><a href="javascript:show_calendar('document.register.ineragateddate', document.register.ineragateddate.value);">
<img src="images/cal.gif" width="18" height="18" border="0"/></a></td>
  </tr>
  <tr>
    <td>InegratedBY</td>
    <td><input type="text" name="ineragatedby"></td>
  </tr>
  <tr>
    <td>usingtechnolgy</td>
    <td><input type="text" name="usingtechnolgy"></td>
  </tr>
  <tr>
    <td>capacity</td>
...
<input type="submit" name="AddHistroy" value="AddHistroy"/></form>
  </td>
</tr>
<tr>
