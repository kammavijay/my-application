...
<tr>
  ...
  <%} %>
 <form action="CustomerFoodDetails.jsp" method="post">
  
   <table width="200" border="1">
      <tr>
        <td><em><strong>Region</strong></em></td>
        <td><label>
          <select name="region"><option value="EuropeanRegion">EuropeanRegion</option>
      ...
      <tr><td></td>                                           <td><input type="submit" name="regionfood" value="Regionfood"/>
   <br></td></tr></table></form>
  </td>
</tr>
<tr>
