...
<tbody><tr>
<td rowspan="3" height="281" valign="top" width="9">&nbsp;<jsp:include page="customer.html"/>
 </td>
...
%>
  ...
  <tr>
    <td bgcolor="#FFFFFF" class="style3 tiny"><span class="style11"><strong>First Name </strong></span></td>
    <td><input type="text" name="fname" class="textfield" value="<%=firstname%>"/>    </td>
  </tr>
  <tr>
    <td bgcolor="#FFFFFF"><span class="style11"><strong>Last Name </strong></span></td>
    <td><input type="text" name="lname" class="textfield" value="<%=lastname%>"/>    </td>
  </tr>
  <tr>
    <td bgcolor="#FFFFFF"><span class="style11"><strong>Birth Date </strong></span></td>
  ...
  <tr>
    <td bgcolor="#FFFFFF"><span class="style11"><strong>City</strong></span></td>
    <td><select name="city">
  ...
  <tr>
    <td bgcolor="#FFFFFF"><span class="style11"><strong>State</strong></span></td>
  ...
  <tr>
    <td bgcolor="#FFFFFF"><span class="style11"><strong>Country</strong></span></td>
    <td><select name="country">
      <option>India</option>
    </select>    </td>
  </tr>
  <tr bgcolor="#FFFFFF">
    <td colspan="2"><div align="center" class="style11"><strong>
