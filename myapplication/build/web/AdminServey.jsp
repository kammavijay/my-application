<%@ page import="com.dts.core.util.*,java.util.*,com.dts.crmofairlines.model.*,com.dts.crmofairlines.dao.*" %>
...
<tr>
<td>
<jsp:include page="Adminoptions.html"/></td></tr>

<tr>
<td><table style="margin-top: 0pt; margin-bottom: 0pt; border-collapse: collapse;" border="0" bordercolor="#111111" cellpadding="0" cellspacing="0" height="366" width="743">
  <tr>
    <td height="85"><% AirLinesSurvey aairlinesurvey=new AirLinesSurvey();

CoreHash acorehash=aairlinesurvey.viewServeyDetails();
Enumeration aenumeration=acorehash.keys();%>
        <table width="520" border="1" bordercolor="#006699">
          <tr>
            <td width="104" bgcolor="#006699"><div align="center"><span class="style4">Loginname</span></div></td>
            <td width="150" bgcolor="#006699"><div align="center"><span class="style4">Emailid</span></div></td>
            <td width="143" bgcolor="#006699"><div align="center"><span class="style4">AirLinesName</span></div></td>
            <td width="95" bgcolor="#006699"><div align="center"><span class="style4">Reason</span></div></td>
          </tr>
          <%while(aenumeration.hasMoreElements())
{
Integer i1=(Integer)aenumeration.nextElement();
AirLineSurvey aairline=(AirLineSurvey)acorehash.get(i1);
String loginname=aairline.getLoginname();
String emailid=aairline.getEmailid();
String airlinesname=aairline.getAirlinesname();
String reason=aairline.getReason();
%>
          <tr>
            <td bgcolor="#FFFFFF"><div align="center"><span class="style5"><%=loginname %></span></div></td>
            <td bgcolor="#FFFFFF"><div align="center"><span class="style5"><%=emailid %></span></div></td>
            <td bgcolor="#FFFFFF"><div align="center"><span class="style5"><%=airlinesname%></span></div></td>
            <td bgcolor="#FFFFFF"><div align="center"><span class="style5"><%=reason%></span></div></td>
          </tr>
          <%} %>
        </table><td><div align="center"><img src="images/abc.gif">
            </div>
        <tbody>
      <tr>
        <td rowspan="2" height="281" valign="top" width="523">&nbsp;</td>
        <td width="220" height="281" valign="top"><p style="font-size: 12px;"><b></b></p>
          <p></p>
