...
<table border="1" bordercolor="#663300"><tr bgcolor="#003366"><td><span class="style4">AirLinesName</span></td>
...
%>
<tr><td><%=airlinesname%></td><td><%=planename%></td><td><%=fromplace%></td><td><%=toplace%></td><td><%=miles%></td><td><%=depart%></td><td><%=returndate%></td><td><%=departtime%></td><td><%=returntime%></td><td><%=price%></td></tr>
<%} %>
</table>
