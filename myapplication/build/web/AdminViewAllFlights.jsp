...
CoreHash acorehash=aflightbooking.viewFlightDetails();
Enumeration aenumeration=acorehash.keys();
String planename=null;%>
<table border="1" bordercolor="#663300"><tr bgcolor="#003366">
<td><span class="style4"><input type="checkbox" name="ch"/></span></td>

<td><span class="style4">AirLinesName</span></td>
<td><span class="style4">PlaneName</span></td>
<td><span class="style4">FromPlace</span></td>
<td><span class="style4">toplace</span></td>
<td><span class="style4">Miles</span></td>
<td><span class="style4">Departdate</span></td>
<td><span class="style4">ReturnDate</span></td>
<td><span class="style4">DepartTime</span></td>
<td><span class="style4">Returntime</span></td>
<td><span class="style4">Price</span></td>
</tr>
...
String airlinesname=aflight1.getAirlinesname();
 planename=aflight1.getPlanename();
...
%>
<tr><td><input type="checkbox" name="i2" value="<%=planename%>" />
<td><%=airlinesname%></td><td><a href="UpdateFlightSchdule.jsp?i2=<%=planename%>"><%=planename%></a></td>
<td><%=fromplace%></td>
<td><%=toplace%></td><td><%=miles%></td>
<td><%=depart%></td><td><%=returndate%></td><td><%=departtime%></td><td><%=returntime%></td><td><%=price%></td></tr>
<%} %>
</table>
