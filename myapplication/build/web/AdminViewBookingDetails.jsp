...
<tr>
  ...
  CoreHash acorehash=aflightbooking.viewAllBookingDetails();
   Enumeration aenumeration=acorehash.keys();
   %>
   <table border="1" bordercolor="#663300">
   <tr bgcolor="#006699">
   <td><div align="center"><span class="style4">LoginName</span></div></td>
   ...
   Flight aflight=(Flight)acorehash.get(i1);
   String loginname1=aflight.getLoginname();
String airlinesname=aflight.getAirlinesname();
String planename=aflight.getPlanename();
String fromplace=aflight.getFromplace();
String toplace=aflight.getToplace();
String departdate=aflight.getDepart();
String returndate=aflight.getReturndate();
String departtime=aflight.getDeparttime();
String returntime=aflight.getReturntime();
double miles=aflight.getMiles();

 %>
 <tr>
 <td><div align="center"><strong><span class="style5"><%out.println("<a href=AdminViewRegisterDetails.jsp?loginname="+loginname1+">"+loginname1+"</a>");%></span></strong></div></td>
 
 <td><div align="center"><strong><span class="style5"><%=airlinesname%></span></strong></div></td>
 <td><div align="center"><strong><span class="style5"><%=planename%></span></strong></div></td>
 <td><div align="center"><strong><span class="style5"><%=fromplace%></span></strong></div></td>
 <td><div align="center"><strong><span class="style5"><%=toplace%></span></strong></div></td>
 <td><div align="center"><strong><span class="style5"><%=departdate%></span></strong></div></td>
 <td><div align="center"><strong><span class="style5"><%=departtime%></span></strong></div></td><td><div align="center"><strong><span class="style5"><%=returntime %></span></strong></div></td><td><div align="center"><strong><span class="style5"><%=miles%></span></strong></div></td></tr>
 <%} %>
  </table>
