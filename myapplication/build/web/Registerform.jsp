...
function validate()
{
   ...
   if ((temp.password.length < 4) || (temp.password.length > 10)) {
                  ...
                  <table width="481" border="0" align="center" >
                        <tr>
                          ...
                          <td><table width="407" border="0" align="center">
                              <tr><td>Email ID</td><td><input name="loginname" type="text"></td></tr>
                              ...
                              </tr><tr><td>Mobile No</td><td><input name="mobileno" type="text"></td></tr>
							  <tr>
                                <td>Birth Date </td>
                                <td>
...
<tr>
  <td height="265" valign="top"><p style="font-size: 12px;"><b>:: Welcome ::</b></p>
    <p><img src="images/abc.gif">
