...
<td height="19" valign="top" width="485">&nbsp;</td>
<td width="249" height="16" rowspan="2" valign="top">
<p align="right"><b>For Online booking
<a title="" href="">
<font color="#f16f01" size="2">click here</font></a></b></p></td></tr>
<tr>

  <td rowspan="2" height="262" valign="top" width="485">
  <br/>
  <br/><%if(request.getParameter("status")!=null)
  { %>
  <%=request.getParameter("status") %>
  <%} %>
  Alaska Airlines Selects Siebel Business Analytics
  
Solution to Deliver Marketing Professionals with Insight to Drive Increased Customer Loyalty
Tuesday, 08 March 2005
 

Siebel Systems, Inc.,a provider of business applications software, announced that Alaska Airlines has selected Siebel Business Analytics as a key component of its customer-focused strategy. Siebel Business Analytics will enable Alaska's marketing professionals to gain rich insights into the airline's customer base. This sophisticated solution will strengthen Alaska's capacity to better evaluate customer behavior, identify purchasing trends, and design promotions that best meet the needs of its expanding customer base.

"Alaska Airlines has built our 73-year-old brand around thinking about the customer first," said Ann Ardizzone, Managing Director of Marketing Programs for Alaska. "With advanced business intelligence capabilities, we will take our commitment to the customer to the next level designing services and programs that provide the greatest value. We also expect our work with Siebel to strengthen our position as a technology leader in making flying as easy as possible."

Alaska Airlines conducted a comprehensive due diligence process before selecting Siebel Business Analytics. This included a thorough evaluation of alternative solutions, development of product prototypes, technical and scalability assessments, and in-depth architectural reviews. </tr>
<tr>
