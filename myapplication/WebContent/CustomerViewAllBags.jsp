...
<tr><td><span class="style7"><%=airlinesname%></span></td><td><span class="style7"><%=bag1cost%></span></td><td><span class="style7"><%=bag2cost%></span></td><td><span class="style7"><%=bag3cost%></span></td><td><span class="style7"><%=bag4cost%></span></td></tr>
  <%}
