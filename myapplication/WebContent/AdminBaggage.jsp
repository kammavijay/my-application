...
function validate()
{
   ...
   if(temp.bag1.value=="" || temp.bag2.value=="" || temp.bag3.value=="" || temp.bag4.value=="")
   {
...
<tr>
  ...
  <%} %>
  <form name="register" method="post" action="Bags.jsp" onsubmit="return validate()">
          <fieldset>
	...
	<%  AirlineName airlinenames=new AirlineName();
      ...
      <tr>
					...
					<td><label>
					  <input name="bag1" type="text" id="bag1">
					</label></td>
				  </tr>
				  <tr>
					<td><strong>Bag3</strong></td>
					<td><input type="text" name="bag2" id="bag2"></td>
				  </tr>
				  <tr>
					<td><strong>Bag(4to10)</strong></td>
					<td><input type="text" name="bag3" id="bag3"></td>
				  </tr>
				  <tr>
					<td><strong>bag(above10)</strong></td>
					<td><input type="text" name="bag4" id="bag4"></td>
				  </tr>
				  <tr>
					<td>&nbsp;</td>
					<td>&nbsp;</td>
				  ...
				  <tr>
					<td><input type="submit" name="AddBagCosts" value="AddBagCosts"/></td>
				  </tr>
				  <tr>
