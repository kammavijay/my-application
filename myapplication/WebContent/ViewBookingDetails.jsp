...
<tr>
  ...
  CoreHash acorehash=aflightbooking.viewBookingDetails(loginname);
...
double miles=aflight.getMiles();
 ...
 %>
 <tr><td><div align="center"><strong><span class="style5"><%=airlinesname%></span></strong></div></td>
 ...
 <td><div align="center"><strong><span class="style5"><%=departtime%></span></strong></div></td>
 <td><div align="center"><strong><span class="style5"><%=returntime %></span></strong></div></td>
 <td><div align="center"><strong><span class="style5"><%=miles%></span></strong></div></td>
 <td><div align="center"><strong><span class="style5"><a href="Baggage1.jsp?id=<%=airid%>&an=<%=airlinesname%>">Add Baggage</a></span></strong></div></td>
 </tr>
 <%} %>
  </table>
