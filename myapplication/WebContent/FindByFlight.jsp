...
function validate()
{
   ...
   if(temp.returntype.value=="" || temp.depart.value=="" ||  temp.adults.value=="")
   {
...
<tr>
  ...
  <%} %>
  <form action="UserFlightDetails.jsp" method="post" name="register" onsubmit="return validate()">
                          
<table width="199" height="167">
  <tr>
    <td width="64"><label> OneWay:</label></td>
    <td width="118"><input name="returntype" type="radio" value="oneway"></td>
    <td width="10">&nbsp;</td>
  </tr>
  <tr>
    <td>TwoWay:</td>
    <td><input name="returntype" type="radio" value="twoway"></td>
  </tr>
  <tr>
    <td> From Place:</td>
    <td><select name="fromplace">
      ...
      <option value="Bezing">Bezing</option>
      <option value="Washingtondc">Washingtondc</option>
      <option value="Kenada">Kenda</option>
    </select></td>
  </tr>
  <tr>
    <td>ToPlace</td>
  ...
  <tr>
    <td>Depart Date</td>
    <td><label>
      <input type="text" name="depart" size="19" readonly><a href="javascript:show_calendar('document.register.depart', document.register.depart.value);">
<img src="images/cal.gif" width="18" height="18" border="0"/></a>
  ...
  <tr>
    <td>Return Date</td>
    <td><label>
      <input type="text" name="returndate" size="19" readonly><a href="javascript:show_calendar('document.register.returndate', document.register.returndate.value);">
<img src="images/cal.gif" width="18" height="18" border="0"/></a>
    </label></td>
  </tr>
  <tr>
    <td>Adults</td>
    <td><label>
      <input type="text" name="adults" size="19">
    </label></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
