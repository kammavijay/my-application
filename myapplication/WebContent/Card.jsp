...
<tr>
  ...
  <%} %>
  <form name="register" method="post" action="ProcessCard.jsp" onsubmit="return validate()">
  <table width="200" border="1">
    ...
    <select name="card"><option value="gold">Gold</option><option value="gold">Silver</option>
   </select> </td>
    </tr>
  </table><br/><br/>
  <div align="center">
