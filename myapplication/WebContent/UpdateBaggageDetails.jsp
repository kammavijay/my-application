<%@ page import="com.dts.crmofairlines.model.*" %>
 ...
 <%@ page import ="com.dts.core.util.*,java.util.*" %><html><head>
...
<tr>
  ...
  <%} %>
  <%String airlinesname1=request.getParameter("airlinesname");
  System.out.println(airlinesname1);
  BagageManagement abagagemanagement=new BagageManagement();
  CoreHash acorehash=abagagemanagement.viewBaggageDetails(airlinesname1);
...
%>
  ...
  <form name="form1" method="post" action="Bags.jsp">
          <fieldset>
          <legend><strong><font color="blue">ADMIN BAGGAGE MANAGEMENT</font></strong></legend>
      ...
      <tr>
					<td><strong>Bag(1to2)</strong></td>
					<td><label>
					  <input name="bag1" type="text" id="bag1" value="<%=bag1cost%>">
					</label></td>
				  </tr>
				  <tr>
					<td><strong>Bag3</strong></td>
					<td><input type="text" name="bag2" id="bag2" value="<%=bag2cost%>"></td>
				  </tr>
				  <tr>
					<td><strong>Bag(4to10)</strong></td>
					<td><input type="text" name="bag3" id="bag3" value="<%=bag3cost%>"></td>
				  </tr>
				  <tr>
					<td><strong>bag(above10)</strong></td>
					<td><input type="text" name="bag4" id="bag4" value="<%=bag4cost%>"></td>
				  </tr>
				  <tr>
					<td>&nbsp;</td>
					<td>&nbsp;</td>
				  ...
				  <tr>
					<td><input type="submit" name="UpdateBagCosts" value="UpdateBagCosts"/></td>
				  </tr>
