...
</script><script type="text/javascript" src="scripts/ts_picker.js"> </script>
</head>
...
<tr>
  ...
  <%} %>
  <form name="register" method="post" action="LoginAction.jsp" onsubmit="return validate()">
  ...
  <center><a href="Registerform.jsp">New User?</a></center>  </td>
</tr>
<tr>
