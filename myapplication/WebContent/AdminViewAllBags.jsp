...
<td height="19" valign="top" width="442">&nbsp;</td>
<td width="292" height="16" rowspan="2" valign="top">
<p align="right"><b>For Online booking
<a title="" href="">
<font color="#f16f01" size="2">click here</font></a></b></p></td></tr>
<tr>

  <td rowspan="2" height="262" valign="top" width="442">
  <br/>
 ...
 BagageManagement abagagemanagement=new BagageManagement();
  CoreHash acorehash=abagagemanagement.viewAllBaggageDetails();
  Enumeration aenumeration=acorehash.keys();
 %>
  <table border="1" bordercolor="#660000"><tr bgcolor="#006699"><td width="88"><span class="style4">AirLinesName</span></td>
  <td width="89"><span class="style4">Bags(1-2)</span></td>
  <td width="60"><span class="style4">Bags(3)</span></td>
  <td width="74"><span class="style4">bags(4-10)</span></td>
  <td width="95"><span class="style4">Above10</span></td>
  </tr>
...
String airlinesname=abagageprofile.getAirlinesname();
  String bag1cost=abagageprofile.getBagtype1cost();
  String bag2cost=abagageprofile.getBagtype2cost();
  String bag3cost=abagageprofile.getBagtype3cost();
 String bag4cost =abagageprofile.getBagtype4cost();
%>

<tr><td><span class="style7"><%out.println("<a href=UpdateBaggageDetails.jsp?airlinesname="+airlinesname+">"+airlinesname+"</a>");%></span></td><td><span class="style7"><%=bag1cost%></span></td><td><span class="style7"><%=bag2cost%></span></td><td><span class="style7"><%=bag3cost%></span></td><td><span class="style7"><%=bag4cost%></span></td></tr>
  <%}
