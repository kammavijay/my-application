...
<tr>
  ...
  <%@ page import="com.dts.core.util.*" %>
   <%
   try{
   if(request.getParameter("AddFoods")!=null)
   {
   String target="Typesoffood.jsp?status=Food is Not Added";
   ...
   String food1=request.getParameter("food1");
      ...
      FoodBean afoodbean=new FoodBean();
      afoodbean.setRegeion(region);
    afoodbean.setTypesoffood1(food1);
    afoodbean.setTypesoffood2(food2);
    afoodbean.setTypesoffood3(food3);
    TypesOfFood atypesofoods=new TypesOfFood();
     boolean flag=atypesofoods.addFoods(afoodbean);
   if(flag)
   {
   out.println("Food is  Added");
    }
    else
    {
  ...
  //  RequestDispatcher rd=request.getRequestDispatcher(target);
   ...
   <%if(request.getParameter("UpdateFoods")!=null)
   {
   String regeion=request.getParameter("region");
   String food1=request.getParameter("food1");
      String food2=request.getParameter("food2");
      String food3=request.getParameter("food3");
      FoodBean afoodbean=new FoodBean();
      afoodbean.setRegeion(regeion);
    afoodbean.setTypesoffood1(food1);
    afoodbean.setTypesoffood2(food2);
    afoodbean.setTypesoffood3(food3);
    TypesOfFood atypesofoods=new TypesOfFood();
     boolean flag=atypesofoods.updateFood(afoodbean);
   if(flag)
   {
     out.println("Food is  Updated");
    }   else
    {
   out.println("Food is  Not Updated");
   } 
 }
    %>
  
   <%if(request.getParameter("DeleteFoods")!=null)
   {
   String regeion=request.getParameter("regeion");
   String food1=request.getParameter("food1");
      String food2=request.getParameter("food2");
      String food3=request.getParameter("food3");
      FoodBean afoodbean=new FoodBean();
    ...
    afoodbean.setTypesoffood3(food3);
    TypesOfFood atypesofoods=new TypesOfFood();
     boolean flag=atypesofoods.deleteFood(afoodbean)	;
    if(flag)
   {
     out.println("Food is Deleted");
    }   else
    {
   out.println("Food is  Not Deleted");
   } 
    }
    %>
  <%if(request.getParameter("regeionfood")!=null)
  {TypesOfFood typesoffood=new TypesOfFood();
  String regeion=request.getParameter("regeion");
 
CoreHash acorehash=typesoffood.viewFoods(regeion);
Enumeration aenumeration=acorehash.keys();%>
<table border="1" bordercolor="#660000">
  <tr bgcolor="#006699"><td><div align="center" class="style3">Regeion</div></td>
  <td><div align="center" class="style3">TypeOfFood1</div></td>
  <td><div align="center" class="style3">TypeOfFood2</div></td>
  <td><div align="center" class="style3">TypeofFood3</div></td>
  </tr>
<%while(aenumeration.hasMoreElements())
{
Integer i1=(Integer)aenumeration.nextElement();
FoodBean afoodbean=(FoodBean)acorehash.get(i1);%>
<tr><td>
<%=afoodbean.getRegeion()%></td><td>
<%=afoodbean.getTypesoffood1()%></td><td>
<%=afoodbean.getTypesoffood2()%></td><td>
<%=afoodbean.getTypesoffood3()%></td></tr>
<% }%></table>
 <%}}catch(Exception e)
 {
 } %>
