...
<td height="19" valign="top" width="437">&nbsp;</td>
<td width="297" height="16" rowspan="2" valign="top">
<p align="right">&nbsp;</p></td></tr>
<tr>

  <td rowspan="2" height="262" valign="top" width="437">
  <br/>
  ...
  CoreHash acorehash=abagagement.viewOneBaggageDetails(loginname);
  Enumeration aenmueration=acorehash.keys();
  %>
  <table border="1" bordercolor="#663300"><tr bgcolor="#006699"><td width="88"><div align="center"><span class="style4">AirLinesName</span></div></td>
  <td width="61"><div align="center"><span class="style4">BagName</span></div></td>
  <td width="66"><div align="center"><span class="style4">Loginname</span></div></td>
  <td width="62"><div align="center"><span class="style4">NoofBags</span></div></td>
  <td width="127"><div align="center"><span class="style4">Totalcost</span></div></td>
  </tr>
  <%
  while(aenmueration.hasMoreElements())
  {
  Integer i1=(Integer)aenmueration.nextElement();
  
  BagageProfile abagageprofile=(BagageProfile)acorehash.get(i1);
  
  String airlinesname=abagageprofile.getAirlinesname();
  String bagname=abagageprofile.getBagname();
  String loginname1=abagageprofile.getLoginname();
  
  double noofbags=abagageprofile.getNoofbags();
  double totalcost=abagageprofile.getTotalcost();
  
  
  
   %>
   <tr><td><div align="center"><span class="style5"><%=airlinesname%></span></div></td><td><div align="center"><span class="style5"><%=bagname%></span></div></td><td><div align="center"><span class="style5"><%=loginname%></span></div></td><td><div align="center"><span class="style5"><%=noofbags%></span></div></td><td><div align="center"><span class="style5"><%=totalcost%></span></div></td></tr>
